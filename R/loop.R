...
#' @param ... dynamic dots that include objects for the body of the loop.
#' @param type the type of loop to construct. along for a sequence alona vector,
#'  row for a sequence along the rows of an object.
#'
#' @export
#' @examples
#' x = as.list(1:5)
